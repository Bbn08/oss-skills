...
description: Research an LFX mentorship project and create a production-grade research folder from an upstream issue URL and project URL
argument-hint: "issue: <upstream_issue_url> project: <lfx_project_page_url>"
allowed-tools: Bash(git *) Bash(gh *) Bash(rg *) Bash(fd *) Bash(find *) Bash(ls *) Bash(sed *) Bash(cat *) WebFetch WebSearch
---
